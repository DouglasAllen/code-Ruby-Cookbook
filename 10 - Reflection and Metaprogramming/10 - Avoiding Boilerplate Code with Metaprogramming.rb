...
p GeneratedFetcher.instance_methods - Object.instance_methods
# => ["fetch_one", "fetch", "fetch_ten", "fetch_all"]

p GeneratedFetcher.new.fetch_one
# Fetching 1.

p GeneratedFetcher.new.fetch_all
# Fetching all.
#---
class Numeric
...
#end
#
#p call_with_args(1, 2) { | n1, n2 | n1 + n2 }                    # => 3
#
#p call_with_args('mammoth') {|x| x.upcase }                    # => "MAMMOTH"
