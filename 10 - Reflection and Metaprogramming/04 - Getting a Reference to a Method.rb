s = 'A string'
p length_method = s.method('length') # => #<Method: String#length>
...
p replacements.collect(&s.method("gsub"))
...
p Welcomer.new.method("an_instance_method").call  
# => "Salutations from a Welcomer object."
p Welcomer.method("a_class_method").call         
