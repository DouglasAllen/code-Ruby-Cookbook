...
p classifier.classify("we sell the cheapest viagra on the market")
# => "Spam"
p classifier.classify("lunch sounds great")
# => "Not spam"
...
p classifier.classify('what!')
# => "Dramatic"
p classifier.classify("who's on first?")
# => "Funny"
p classifier.classify('perchance to dream')
# => "Interesting"
